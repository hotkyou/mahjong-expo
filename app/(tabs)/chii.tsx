...
const data = [
  ...
  { name: 'Dream', population: 20, color: '#FFCE56', legendFontColor: '#7F7F7F', legendFontSize: 15 },
...
export default function PieChartScreen() {
  return (
    <LinearGradient style={styles.container} colors={['#0396FF', '#ABDCFF']} start={{x: 0.1, y: 0.3}} end={{x: 0.9, y: 0.9}}>
